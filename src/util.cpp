...
int nAnonymizeTellionAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Tellion
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Tellion
    // Mac: ~/Library/Application Support/Tellion
    // Unix: ~/.Tellion
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tellion";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "tellion.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "telliond.pid"));
